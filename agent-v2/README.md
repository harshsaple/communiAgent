...
POC with SQS for Agent V2 Communication



Change Path File of JSON (Credentials Files of AMEX and Citi) to your local file path
...
```
cd existing_repo
git remote add origin https://gitlab.com/preciselydata/DI-Suite-SaaS-Platform/agent-v2-poc.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.com/preciselydata/DI-Suite-SaaS-Platform/agent-v2-poc/-/settings/integrations)
